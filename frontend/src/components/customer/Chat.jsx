...
export default function Chat() {
  ...
  const handleSend = async () => {
    ...
    setMessages(prev => [...prev, {
      id: Date.now(), senderRole: 'user', message: text,
    ...
    <div className="flex flex-col h-full bg-gray-50 relative">
      <div className="bg-white px-6 py-4 sticky top-0 z-10 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-black text-gray-900 leading-tight">Worker</h1>
      ...
      <div className="flex-1 p-6 flex flex-col gap-4 overflow-y-auto pb-28">
        {loading && (
          <div className="text-center text-gray-400 text-sm font-medium">Loading messages…</div>
        )}
