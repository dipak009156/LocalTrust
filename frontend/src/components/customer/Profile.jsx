      ...
      <div className="max-w-2xl mx-auto w-full p-6 flex flex-col gap-8 overflow-y-auto">
        <div className="flex flex-col items-center">
          <div className="relative group">
            <div className="w-28 h-28 rounded-full bg-gradient-to-tr from-blue-600 to-blue-400 border-4 border-white shadow-xl flex items-center justify-center text-4xl font-black text-white mb-4">
              P
            </div>
          ...
          <h2 className="text-2xl font-black text-gray-900">Priya Sharma</h2>
          <p className="text-sm font-bold text-gray-500 mt-1 uppercase tracking-widest">+91 98765 43210</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          {[
            { label: 'Location', value: 'Andheri West, Mumbai', icon: MapPin, color: 'text-blue-600', bg: 'bg-blue-50' },
