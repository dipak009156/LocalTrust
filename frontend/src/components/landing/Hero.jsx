      ...
      <div className="text-center md:text-left flex flex-col items-center md:items-start">
        ...
        <div className="flex flex-col sm:flex-row w-full max-w-sm gap-4">
          ...
          <button
            ...
            className="flex-1 bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 md:py-4 px-6 rounded-2xl text-base transition-all active:scale-[0.98] shadow-lg shadow-blue-200 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 md:py-4 px-6 rounded-2xl text-base transition-all active:scale-[0.98] shadow-lg shadow-orange-200 flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
